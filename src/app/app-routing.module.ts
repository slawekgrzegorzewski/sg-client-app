...
import {
  ACCOUNTANT_HOME_ROUTER_URL,
  AccountantHomeComponent
} from './accountant/pages/accountant-home/accountant-home.component';
import {
  ACCOUNTANT_HISTORY_ROUTER_URL,
  AccountsHistoryComponent
} from './accountant/pages/accounts-history/accounts-history.component';
import {BILLING_SMALL_ROUTER_URL, BillingSmallComponent} from './accountant/pages/billings/billing-small.component';
import {
  PIGGY_BANKS_SMALL_ROUTER_URL,
  PiggyBanksSmallComponent
} from './accountant/pages/piggy-banks/piggy-banks-small.component';
import {CHARTS_ROUTER_URL, ChartsComponent} from './accountant/pages/charts/charts.component';
import {
  CHECKER_HOME_ROUTER_URL,
  CheckerHomeComponent
} from './periodic-checker/pages/checker-home/checker-home.component';
...
import {
  LOAN_SIMULATOR_ROUTER_URL,
  LoanSimulatorComponent
} from './accountant/pages/loan-simulator/loan-simulator.component';
...
const routes: Routes = [
  ...
  {path: IPR_REPORTS_ROUTER_URL, redirectTo: `/${IPR_REPORTS_ROUTER_URL}/`, pathMatch: 'full'},
  {path: `${IPR_REPORTS_ROUTER_URL}/:domainId`, component: IPRReportsComponent, canActivate: [UserLoggedInGuard]},
  ...
  {path: LOAN_SIMULATOR_ROUTER_URL, redirectTo: `/${LOAN_SIMULATOR_ROUTER_URL}/`, pathMatch: 'full'},
  {path: `${LOAN_SIMULATOR_ROUTER_URL}/:domainId`, component: LoanSimulatorComponent, canActivate: [UserLoggedInGuard]},
