import {CurrentSelection, Move} from './models';
...
export class UserActionInterpreter {
  private readonly RIGHT_MOVES: { [key: string]: Move } = {};
  private readonly LEFT_MOVES: { [key: string]: Move } = {};
  private readonly DOWN_MOVES: { [key: string]: Move } = {};
  private readonly UP_MOVES: { [key: string]: Move } = {};
