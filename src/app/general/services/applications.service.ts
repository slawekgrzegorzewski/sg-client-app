...
import {LOAN_SIMULATOR_ROUTER_URL} from '../../accountant/pages/loan-simulator/loan-simulator.component';
...
export const APPLICATIONS_CONFIG = new Map<string, ApplicationConfig>([
  [ACCOUNTANT_APP, new ApplicationConfig([ACCOUNTANT_HOME_ROUTER_URL, ACCOUNTANT_HISTORY_ROUTER_URL, HOLIDAY_CURRENCIES_ROUTER_URL,
    BILLING_SMALL_ROUTER_URL, PIGGY_BANKS_SMALL_ROUTER_URL, CHARTS_ROUTER_URL, SETTINGS_ROUTER_URL, LOAN_SIMULATOR_ROUTER_URL])],
